...
def process(
    ...
    total_bx    = sum((r.get("bx") or 0)    for r in summary)
    total_valor = sum((r.get("valor") or 0) for r in summary)
    total_bruto = sum((r.get("bruto") or 0) for r in summary)
    total_neto  = sum((r.get("neto") or 0)  for r in summary)
    total_m2    = sum((r.get("m2") or 0)    for r in summary)
